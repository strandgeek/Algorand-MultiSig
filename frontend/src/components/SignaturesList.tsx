  ...
  return (
    <div>
      {signedTransactions.map(signedTransaction => {
        ...
        const signedAt = moment(signedTransaction.created_at).fromNow();
        return (
          <div
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4 text-sm">{getShortAddress(address)}</div>
            </div>
            <div className="flex items-center justify-end">
              <div className="tooltip tooltip-right" data-tip={signedAt}>
